export type ThemeId = "DarkFlame" | "Night" | "LightFlame" | "ColdBlue" | "Forest" | "Mono";

export const themes: { id: ThemeId; accent: string }[] = [
...
const vars: Record<ThemeId, Record<string, string>> = {
  DarkFlame: {
