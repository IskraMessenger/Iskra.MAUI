...
{
#if WINDOWS
    private const string Aumid = "com.iskra.maui";
    private const string ShortcutFileName = "Iskra.lnk";
#endif
    ...
    private static void TryRegisterWindows()
    {
        try
        {
            ...
            if (!Preferences.Default.Get("toast_probe_v2", false))
            {
                ...
                ShowToast(0, "Iskra", Loc.T("notify.new_message"));
            }
        }
        catch (Exception ex)
        {
    ...
    private static void EnsureStartMenuShortcut()
    {
        ...
        CreateShortcut(shortcutPath, exePath, Aumid, "Iskra");
