...
/// <summary>
/// Cross-platform app data: <c>ISKRA_DATA_DIR</c>, else LocalApplicationData/Iskra/Web
...
internal static class WebAppPaths
{
    ...
    {
        var fromEnv = Environment.GetEnvironmentVariable("ISKRA_DATA_DIR");
